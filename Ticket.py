...
customer1 = Customer("Koko", "Jambo", True)
customer2 = Customer("Tricky", "Nicky", False)
customer3 = Customer("Linky", "Vlad", True)
customer4 = Customer("Keda", "Igor", False)

process = PaymentProcess()
process.buy_ticket(customer1, event)
process.buy_ticket(customer2, event)
process.buy_ticket(customer3, event)
process.buy_ticket(customer4, event)


event.find_already_bought_ticket("61aacd7a-61f1-11ed-8e07-3aa4d2f593db")
event.find_already_bought_ticket("61aaea76-61f1-11ed-8e07-3aa4d2f593db")